 ...
 */
public class ResetThumbActivity extends AppCompatActivity implements Runnable, SGFingerPresentEvent{
    ...
    private final BroadcastReceiver mUsbReceiver1 = new BroadcastReceiver()
    {
        public void onReceive(Context context, Intent intent)
        {
            ...
            if (ACTION_USB_DETACHED.equals(action))
            {
                ...
                if (device != null)
                {
                    Toast.makeText(ResetThumbActivity.this, "Device disconnected", Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            public void onClick(View v)
            {
                ...
                alertDialog.setPositiveButton("Switch To Attendance", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(ResetThumbActivity.this, AttendanceActivity.class);
                        startActivity(intent);
                        finish();
                    }
                });
                alertDialog.setNegativeButton("Switch To Registration", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        //editor = pref.edit();
                        //editor.clear();
                        ...
                        //session.logoutUser();
                        progress_layout.setVisibility(View.VISIBLE);
                        Intent intent = new Intent(ResetThumbActivity.this, ThumbRegistration.class);
                        startActivity(intent);
                        finish();
                    }
                });
        ...
        auto_on = new SGAutoOnEventNotifier(sgfplib, ResetThumbActivity.this);
        auto_on.start();
        //Log.i("auto_on_start", "auto_on_start");
        ...
        if (!ed_MobNo.getText().toString().equals(""))
        {
            if (MobileNo.length() >= 10)
            {
                if (!txt_empName.getText().toString().equals(""))
                {
                    ...
                    {
                        img_register1.setImageBitmap(ResetThumbActivity.toGrayscale(mRegisterImage));
                        ...
                        if (str.equalsIgnoreCase(base64))
                        {
                            ...
                            img_register1.setImageBitmap(grayBitmap);
                            Toast.makeText(ResetThumbActivity.this, "Thumb not registered properly. Please try again", Toast.LENGTH_LONG).show();
                    ...
                    {
                        img_register2.setImageBitmap(ResetThumbActivity.toGrayscale(mRegisterImage));
                ...
                else
                {
                    try
                    {
                        ...
                        else if (responsecode.equals("2"))
                        {
                            ...
                            alertDialog.setTitle("Register Thumb");
